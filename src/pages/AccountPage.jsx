...
export default function AccountPage({
  ...
  async function handleProfileSubmit(e) {
    ...
    setProfileMessage(error ? { type: 'error', text: error.message } : { type: 'success', text: 'Saved.' })
  }
    ...
    return (
      <div className="flex flex-col items-center pt-12 px-6">
        <p className="text-base text-slate-600">
          Add Supabase credentials to .env to use account settings.
        </p>
      </div>
    )
  }
    ...
    <div className="flex flex-col items-center gap-8 pt-12 px-6 pb-16">
      ...
      <div className="grid w-full max-w-[1600px] grid-cols-[repeat(auto-fill,minmax(300px,500px))] justify-center gap-8">
        ...
        <section className={sectionClass}>
          <h3 className="text-xl font-medium text-slate-800">Name & Location</h3>
          ...
          {profileLoading ? (
            ...
            <form onSubmit={handleProfileSubmit} className="mt-4 space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <label htmlFor="ac-first_name" className={labelClass}>
                    First name *
                  </label>
                  <input
                    id="ac-first_name"
                ...
                <div>
                  <label htmlFor="ac-last_name" className={labelClass}>
                    Last name *
                  </label>
                  <input
                    id="ac-last_name"
              ...
              <div>
                <label htmlFor="ac-country" className={labelClass}>
                  Country
                </label>
                <select
                  id="ac-country"
                  ...
                  onChange={(e) =>
                    setProfile((p) => ({ ...p, country: e.target.value, state: '' }))
                  }
                  className={inputClass}
                >
              ...
              {profile.country && (
                <div>
                  <label htmlFor="ac-state" className={labelClass}>
                    State / Province
                  </label>
                  <select
                    id="ac-state"
                  ...
                  >
                    ...
                    {(STATES_BY_COUNTRY[profile.country] ?? []).map((s) => (
              ...
              <div>
                <label htmlFor="ac-city" className={labelClass}>
                  City
                </label>
                <input
                  id="ac-city"
        ...
        <section className={sectionClass}>
          ...
          <p className="mt-1 text-min text-slate-600">
            Choose your background color. It syncs across devices.
          </p>
          <div className="mt-4 flex flex-row items-center gap-3">
            ...
            />
            <span className="text-min text-slate-600">{bgColor}</span>
          </div>
        </section>
